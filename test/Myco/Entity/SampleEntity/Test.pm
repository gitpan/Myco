package Myco::Entity::SampleEntity::Test;
...
my $class = 'Myco::Entity::SampleEntity';
...
#	type => sub {
#                   my $test = shift;
#	            my $foo = Myco::Entity::SampleEntity->new(name => 'bar');
...
###
### Unit Tests for Myco::Entity::SampleEntity
###
...
L<Myco::Entity::SampleEntity|Myco::Entity::SampleEntity>,
