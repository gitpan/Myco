...
Myco::Entity::Meta, as a companion to Myco::Entity (and more
...
When used as intended, Myco::Entity::Meta takes care of much of the process of
...
much of the functionality provide by Myco::Entity::Meta may be added with just
these modifications:
...
=item 2. Remove this existing statement:
 ...
 Myco::Entity::import_schema(__PACKAGE__);
...
hash maps attribute names to respective Myco::Entity::Meta::Attribute
...
our $schema =
  {
   fields =>
    { transient =>
      ...
      ref => { ui => { class => 'Myco::Entity::Meta::UI' } },
    },
  };
...
C<Myco::Entity::import_schema()>.  This statement should be placed
...
L<Myco::Entity::Meta::Query|Myco::Entity::Meta::Query> and L<Myco::QueryTemplate|Myco::QueryTemplate>
...
sub add_query {
    ...
    my $isa = join '', @Myco::Entity::Meta::Query::ISA;
    eval "require Myco::Entity::Meta::Query"
    ...
    eval {
        $new_query = Myco::Entity::Meta::Query->new( %query_attrs );
    };
    if ($@) {
        Myco::Exception::Meta->throw
            ( error => 'Exception during attempt to constuct the new'
...
L<Myco::Entity::Meta::Test|Myco::Entity::Meta::Test>,
L<Myco|Myco>,
L<Tangram|Tangram>,
